<div class="card card-outline-info">
      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-3">
                <input id="basic_checkbox_{{$serviciosItem->id}}"  type="checkbox" name="habilitado" @if($serviciosItem->habilitado == 1 ) checked="" @endif>
        <label for="basic_checkbox_{{$serviciosItem->id}}">Habilitado</label>
            </div>
