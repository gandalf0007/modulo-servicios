...
<div class="input-group input-icon right ">
	...
	<input type="text"   class="form-control" name="password3">
</div>
</div>
...
<div class="input-group input-icon right ">
 <span class="input-group-btn"><button class="btn btn-info" type="button">  <i class="fa fa-link"> URL Email: </i></button></span>
	<input type="text"   class="form-control" name="urlemail">
</div>
</div>
...
<div class="input-group">
    <span class="input-group-addon" id="basic-addon3"><i class="fa fa-calendar"></i></span>
      <input type="text" name="inicio" class="form-control mydatepicker" id="datepicker" aria-describedby="basic-addon3" placeholder="Fecha de Inicio">
  </div>
</div>
